	...
	<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
		...
		<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
			...
			<ul class="menu-nav">
				...
				<li class="menu-item  <?= ($this->uri->segment(1) == 'dues'  && $this->uri->segment(2) == 'add') ? 'menu-item-active' : ''; ?>" aria-haspopup="true">
					<a href="<?php echo base_url('dues/add'); ?>" class="menu-link">
						<span style="    font-size: 20px !important;" class="far fa-clipboard text-dark-50 ">
							<!--end::Svg Icon-->
						</span>
						<span class="menu-text ml-3"> Add Dues</span>
					</a>
				</li>
				<li class="menu-item  <?= ($this->uri->segment(1) == 'dues'  && $this->uri->segment(2) == 'list') ? 'menu-item-active' : ''; ?>" aria-haspopup="true">
					<a href="<?php echo base_url('dues/list'); ?>" class="menu-link">
						<span style="    font-size: 20px !important;" class="far fa-list-alt text-dark-50 ">
							<!--end::Svg Icon-->
						</span>
						<span class="menu-text ml-3"> Dues List</span>
					</a>
				</li>
