            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Dues Listing
                            <span class="d-block text-muted pt-2 font-size-sm">Dues listing & information</span>
                        </h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="<?php echo base_url('dues/add'); ?>" class="btn btn-light-primary btn-pill font-weight-bolder">
